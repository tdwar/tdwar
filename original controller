({
    doInit : function(component, event, helper) {
        component.set('v.calloutStatus','Not Started');
        ...
        action2.setCallback(this, function(a){
            ...
            if(state2 == "SUCCESS"){
                ...
                if(a.getReturnValue() != null && a.getReturnValue() != ''&& a.getReturnValue() != undefined){
                    ...
                    console.log('SecAPI Scan status : '+component.get('v.ReleaseObject').SEC_API_Scan_Status__c);
                    component.set('v.calloutStatus',component.get('v.ReleaseObject').SEC_API_Scan_Status__c);
                    component.set('v.calloutStatus',component.get('v.ReleaseObject').SEC_API_Scan_Status__c);
    ...
    handleResetScan : function(component, event, helper){
        ...
        action.setCallback(this, function(a){
            ...
            if(state=='SUCCESS'){
                ...
                component.set('v.progressNumber',0);
                 component.set('v.scanStatus','');
                component.set('v.showSpinner',false);
                $A.get('e.force:refreshView').fire();
				var a = component.get('c.doInit');
        		$A.enqueueAction(a);
